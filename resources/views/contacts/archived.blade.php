...
<x-breadcrumb :items="[
    ...
    ['label' => 'Liste', 'url' => route('contacts.index')],
            ...
            <tbody>
                ...
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <form action="{{ route('contacts.restore', ['id' => $contact->id]) }}" method="POST">
                            @csrf
                            <button type="submit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Restaurer</button type="submit">
                        </form>
                        <form action="{{ route('contacts.forceDelete', ['id' => $contact->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
