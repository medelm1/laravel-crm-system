...
<x-breadcrumb :items="[
    ...
    ['label' => 'Interactions', 'url' => null]
]" />

<div class="bg-white border border-gray-200 rounded rounded-md p-4 mb-2">
    <h2 class="text-2xl font-semibold">Interactions pour {{ $contact->name }}</h2>
</div>
            ...
            <tbody>
                ...
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <a href="{{ route('interactions.details', ['id' => $interaction->id]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Voir</a>
                        <a href="{{ route('interactions.edit', ['id' => $interaction->id]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Modifier</a>
                        <form action="{{ route('interactions.softDelete', ['id' => $interaction->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
